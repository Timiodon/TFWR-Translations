...
def spawn_drone(task: Callable[[], Any]) -> Any:
	"""
	Spawns a new drone in the same position as the drone that ran the `spawn_drone(task)` command. The new drone then begins executing the specified `task` function. After it is done, it will disappear automatically.
